...
class SnakeGame:
    ...
    def on_init(self):
        ...
        # fruit position
        self.fruit_position = [random.randrange(1, (self.window_width // 10)) * 10,
    ...
    def on_execute(self):
        ...
        while self._running:
            ...
            if self.snake_position[0] < 0 or self.snake_position[0] > self.window_width - 10:
                self.game_over()
            if self.snake_position[1] < 0 or self.snake_position[1] > self.window_height - 10:
                self.game_over()
